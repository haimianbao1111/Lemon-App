...
namespace Lemon_App
{
    ...
    public class SettingsData
    {
        ...
        public List<string> MIDLIST { get; set; } = new List<string>();
    }
    public class OnRect
    {
        public double x = 0;
    ...
    public class LemonWeather
    {
        ...
        public LemonWeather(string info)
        {
            try
            {
                HttpWebRequest hwr = (HttpWebRequest)WebRequest.Create($"https://free-api.heweather.com/v5/now?city={Uri.EscapeUriString(info)}&key=f97e6a6ad4cd49babd0538747c86b88d");
